...
class WriterFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function itShouldCreateColumnWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\ColumnWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateWhereWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\WhereWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateSelectWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\SelectWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateInsertWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\InsertWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateUpdateWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\UpdateWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateDeleteWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\DeleteWriter', \get_class($writer));
    }
    ...
    public function itShouldCreatePlaceholderWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\PlaceholderWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateIntersectWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\IntersectWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateMinusWriter()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\MinusWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateUnion()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\UnionWriter', \get_class($writer));
    }
    ...
    public function itShouldCreateUnionAll()
    {
        ...
        $this->assertSame('Sql\QueryBuilder\Builder\Syntax\UnionAllWriter', \get_class($writer));
    }
}
